...
contract BaseToken is IERC20, Ownable
{
    ...
    function burn(uint256 _value) onlyMaster external
    {
        require(balances[msg.sender] >= _value);
...
contract CreetToken is BaseToken
{
    ...
    uint256 constant private INITIAL_TOKEN_SUPPLY = 5000000000;
    ...
    constructor() public
    {
        ...
        totalSupply = INITIAL_TOKEN_SUPPLY * E18;

        balances[msg.sender] = totalSupply;
    }

    function updateMandate(bool _value) external onlyWhenNotStopped
    {
        mandates[msg.sender] = _value;
    }

    function transferByMandate(address _from, address _to, uint256 _value) external onlyWhenNotStopped onlyMaster returns (bool)
    {
        require(_from != address(0));
        require(balances[_from] >= _value);
        require(mandates[_from]);
    ...
    function referralDrop2(address _to, uint256 _value, address _sale, uint256 _fee) external onlyWhenNotStopped onlyMaster returns (bool)
    {
    ...
    function referralDrop3(address _to1, uint256 _value1, address _to2, uint256 _value2, address _sale, uint256 _fee) external onlyWhenNotStopped onlyMaster returns (bool)
    {
